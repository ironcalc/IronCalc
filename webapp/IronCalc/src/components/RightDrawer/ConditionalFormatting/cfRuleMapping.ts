...
const PRESET_ICONS: Record<string, Icon[]> = {
  ...
  "shapes-3-multiple": ["Rhombus", "TriangleUpFilled", "Circle"],
  "shapes-4-circles": ["Circle", "Circle", "Circle", "Circle"],
  "ind-2-triangles": ["TriangleUpFilled", "TriangleDownFilled"],
  "ind-2-arrows": ["ArrowUp", "ArrowDown"],
  "ind-2-thumbs": ["ThumbsUp", "ThumbsDown"],

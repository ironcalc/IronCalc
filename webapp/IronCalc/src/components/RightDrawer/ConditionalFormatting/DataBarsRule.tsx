...
export interface DataBarBound {
  type: DataBarBoundType;
  value: string;
}
...
const VALUE_DISABLED_TYPES: DataBarBoundType[] = ["automatic", "min", "max"];
...
const DataBarsRule = ({
  ...
  const [selected, setSelected] = useState<DataBarsRuleData>(
    initialValues ?? {
      ...
      minBound: { type: "automatic", value: "" },
      maxBound: { type: "automatic", value: "" },
    },
  );
  ...
  const minTypeOptions = [
    {
      value: "automatic",
      label: t("conditional_formatting.data_bars_type_automatic"),
    },
    { value: "min", label: t("conditional_formatting.color_scale_type_min") },
    {
      value: "number",
      label: t("conditional_formatting.color_scale_type_number"),
    },
    {
      value: "percent",
      label: t("conditional_formatting.color_scale_type_percent"),
    },
    {
      value: "percentile",
      label: t("conditional_formatting.color_scale_type_percentile"),
    },
    {
      value: "formula",
      label: t("conditional_formatting.color_scale_type_formula"),
    },
  ];
  ...
  const maxTypeOptions = [
    ...
    { value: "max", label: t("conditional_formatting.color_scale_type_max") },
    {
      value: "number",
      label: t("conditional_formatting.color_scale_type_number"),
    },
      ...
      <div className="ic-edit-rule-content">
        ...
        <div className="ic-edit-rule-section">
          ...
          <div className="ic-edit-rule-values-row">
            <div className="ic-edit-rule-field-wrapper">
              <span className="ic-edit-rule-label">
                {t("conditional_formatting.data_bars_minimum")}
              </span>
              <Select
                value={selected.minBound.type}
                options={minTypeOptions}
                onChange={(type) =>
                  setSelected((s) => ({
                    ...s,
                    minBound: { type: type as DataBarBoundType, value: "" },
                  }))
                }
                hideCheck
              />
              <Input
                type="text"
                value={selected.minBound.value}
                disabled={VALUE_DISABLED_TYPES.includes(selected.minBound.type)}
                onChange={(e) =>
                  setSelected((s) => ({
                    ...s,
                    minBound: { ...s.minBound, value: e.target.value },
                  }))
                }
              />
            </div>
            <div className="ic-edit-rule-field-wrapper">
              <span className="ic-edit-rule-label">
                {t("conditional_formatting.data_bars_maximum")}
              </span>
              <Select
                value={selected.maxBound.type}
                options={maxTypeOptions}
                onChange={(type) =>
                  setSelected((s) => ({
                    ...s,
                    maxBound: { type: type as DataBarBoundType, value: "" },
                  }))
                }
                hideCheck
              />
              <Input
                type="text"
                value={selected.maxBound.value}
                disabled={VALUE_DISABLED_TYPES.includes(selected.maxBound.type)}
                onChange={(e) =>
                  setSelected((s) => ({
                    ...s,
                    maxBound: { ...s.maxBound, value: e.target.value },
                  }))
                }
              />
            </div>

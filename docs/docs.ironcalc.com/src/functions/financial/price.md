...
* Dates should be entered as cell references or via the [DATE](/functions/date_and_time/date) function, not as text strings.
...
See also [YEARFRAC](/functions/date_and_time/yearfrac) and the [basis glossary](/functions/financial#basis-glossary).

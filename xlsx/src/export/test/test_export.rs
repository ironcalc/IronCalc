...
fn test_values() {
    ...
    // numbers
    model.set_user_input(0, 1, 1, "123.456".to_string()).unwrap();
    // strings
    model.set_user_input(0, 2, 1, "Hello world!".to_string()).unwrap();
    ...
    // errors
    model.set_user_input(0, 7, 1, "#VALUE!".to_string()).unwrap();

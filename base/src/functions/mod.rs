    ...
    ($($field:ident => $variant:ident),+ $(,)?) => {
        impl Functions {
            pub fn lookup(&self, name: &str) -> Option<Function> {
                ...
                // New financial functions without localization support
                match key.as_str() {
                    "ACCRINT" => return Some(Function::Accrint),
                    "ACCRINTM" => return Some(Function::Accrintm),
                    "COUPDAYBS" => return Some(Function::Coupdaybs),
                    "COUPDAYS" => return Some(Function::Coupdays),
                    "COUPDAYSNC" => return Some(Function::Coupdaysnc),
                    "COUPNCD" => return Some(Function::Coupncd),
                    "COUPNUM" => return Some(Function::Coupnum),
                    "COUPPCD" => return Some(Function::Couppcd),
                    "DISC" => return Some(Function::Disc),
                    "DURATION" => return Some(Function::Duration),
                    "FVSCHEDULE" => return Some(Function::Fvschedule),
                    "INTRATE" => return Some(Function::Intrate),
                    "MDURATION" => return Some(Function::Mduration),
                    "PRICE" => return Some(Function::Price),
                    "PRICEDISC" => return Some(Function::Pricedisc),
                    "PRICEMAT" => return Some(Function::Pricemat),
                    "RECEIVED" => return Some(Function::Received),
                    "YIELD" => return Some(Function::Yield),
                    "YIELDDISC" => return Some(Function::Yielddisc),
                    "YIELDMAT" => return Some(Function::Yieldmat),
                    _ => {}
                }
                $(
                    if self.$field == key {

...
<<<<<<< HEAD:base/src/functions/mathematical.rs
...
=======
>>>>>>> 78e85a6c (refactor: move GCD and LCM to their own file with shared logic):base/src/functions/math_and_trigonometry/mathematical.rs

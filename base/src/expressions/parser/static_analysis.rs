...
fn get_function_args_signature(kind: &Function, arg_count: usize) -> Vec<Signature> {
    match kind {
        ...
        Function::QuartileInc => vec![Signature::Vector, Signature::Scalar],
        Function::Rank => vec![Signature::Scalar, Signature::Vector, Signature::Scalar],
...
fn static_analysis_on_function(kind: &Function, args: &[Node]) -> StaticResult {
    match kind {
        ...
        Function::Rank => StaticResult::Scalar,

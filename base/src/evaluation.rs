...
pub(crate) enum Restart {
    ...
    ///   C3 = SEQUENCE(3)
    /// The evaluation order in A1, B2, C3, no restarts. C3 is #SPILL!
    /// Now we set A1 = 0. A2 will read C1 and force it's evaluation that will still be blocked by the stale spill from the previous C3 evaluation.
